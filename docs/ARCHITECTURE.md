...
| worker cron trigger | every 10 minutes | the pool's own scheduler: dispatches any workflow above whose last run is overdue (GitHub's cron is best-effort); see RUNBOOK |
