  ...
  it("counts the names, the objects and the second copies' bytes", async () => {
    await env.DB.batch([
      env.DB.prepare(`INSERT INTO packages (sha256, name, version, arch, filename, size_download, size_installed, has_signature, manifest_json, source, r2_key, repo_arch) VALUES
        ('1', 'fonts', '1-1', 'any', 'fonts-1-1-any.pkg.tar.zst', 100, 1, 0, '{}', 'extra', 'x86_64/fonts', 'x86_64'),
        ('2', 'fonts', '1-1', 'any', 'fonts-1-1-any.pkg.tar.zst', 120, 1, 0, '{}', 'alarm', 'aarch64/fonts', 'aarch64'),
        ('3', 'docs', '2-1', 'any', 'docs-2-1-any.pkg.tar.zst', 50, 1, 0, '{}', 'extra', 'x86_64/docs', 'x86_64'),
        ('4', 'zlib', '1-1', 'x86_64', 'zlib-1-1-x86_64.pkg.tar.zst', 30, 1, 0, '{}', 'core', 'x86_64/zlib', 'x86_64')`),
