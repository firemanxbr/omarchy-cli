...
const BODY = String.raw`
  ...
  <section id="rings-section">
    <div class="h2row"><h2>Pick a ring</h2><a class="more-link" href="/docs/get-started">Which ring is for me? →</a></div>
  ...
  <section id="get-started">
    <div class="h2row"><h2>Get started</h2><a class="more-link" href="/docs/get-started">The chapter, with the thin client →</a></div>
